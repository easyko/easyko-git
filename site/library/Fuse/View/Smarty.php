...
//			$this->_smarty->allow_php_tag = true;
            ...
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."login";
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."main";
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."statistics";
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."common";
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."product";
            $secure_dirs[] = $path.DIRECTORY_SEPARATOR."checkout";
