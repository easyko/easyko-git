<?php /* Smarty version Smarty-3.1.12, created on 2019-05-06 21:33:28
         compiled from "/usr/local/web/test/pm/site/template/view/weekly_list.html" */ ?>
<?php /*%%SmartyHeaderCode:1911079925cd037a83045e0-90541063%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63b76e33bcf27c3e229edfb5491d07852ba8e1f9' => 
    array (
      0 => '/usr/local/web/test/pm/site/template/view/weekly_list.html',
      1 => 1466349813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1911079925cd037a83045e0-90541063',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd037a83aefe9_06941525',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd037a83aefe9_06941525')) {function content_5cd037a83aefe9_06941525($_smarty_tpl) {?><!DOCTYPE html>
...
" style="color: #60a6ee"><?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
                                        ...
                                        <td><a href="javascript:;" onclick="del('<?php echo $_smarty_tpl->tpl_vars['row']->value['weekly_id'];?>
...
function del(weekly_id) {
	if (!confirm('删除不可恢复，确定要删除么？')) {
		return;
	}

	var url = 'weekly_report.php?task=del&weekly_id=' + weekly_id;
