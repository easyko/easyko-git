<?php /* Smarty version Smarty-3.1.12, created on 2019-08-23 10:39:20
         compiled from "F:\www\demo\site\template\login\signin.html" */ ?>
<?php /*%%SmartyHeaderCode:146645d5f51d8b95a17-22377171%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3168abe8164d05faed970833adfd515d8b4fc96c' => 
    array (
      0 => 'F:\\www\\demo\\site\\template\\login\\signin.html',
      1 => 1566524794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '146645d5f51d8b95a17-22377171',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5f51d8bd0b06_43945388',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5f51d8bd0b06_43945388')) {function content_5d5f51d8bd0b06_43945388($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
        ...
        $(function () {
            ...
            $(".signin").click(function () {
                ...
                if($(".loginTab").hasClass("active")){  //通过账号登录
                    ...
                    $.post('/login/index.php?task=index',{account: userAccount, password: password, formhash: formhash, type: 1},
                        function(data) {
                    ...
                    $.post('/login/index.php?task=index',{phone: mobile, smscode: code, formhash: formhash},
                        function(data) {
                            data = JSON.parse(data);
                            if(data.status == 'LOGIN_SUCCESS') {
                                //登陆成功跳转管理内容页面
...
">
                        ...
                        <div class="single-card-actions-desc form-group">
                            <div class="btn-pair"> 或 <a href="../register">注册企业/团队</a></div>
                        </div>
                    </form>
                </div>
            </div>
