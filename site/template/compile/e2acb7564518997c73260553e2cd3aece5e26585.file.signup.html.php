<?php /* Smarty version Smarty-3.1.12, created on 2019-08-23 10:39:24
         compiled from "F:\www\demo\site\template\login\signup.html" */ ?>
<?php /*%%SmartyHeaderCode:9935d5f51dc0a3504-45667995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2acb7564518997c73260553e2cd3aece5e26585' => 
    array (
      0 => 'F:\\www\\demo\\site\\template\\login\\signup.html',
      1 => 1566524794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9935d5f51dc0a3504-45667995',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5f51dc0de2b6_77714575',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5f51dc0de2b6_77714575')) {function content_5d5f51dc0de2b6_77714575($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        $(function(){
            ...
            $(".getCode").click(function(){
                ...
                $.post('/register/index.php?task=sendsms',{phone: mobile, type: 1, formhash: formhash},
                    function(data) {
            ...
            $(".next").click(function(){
                ...
                var formhash = $(".formhash").val();
                $.post('/register/index.php?task=index',{phone: mobile, verCode: code, formhash: formhash},
                    function(data) {
                        data = JSON.parse(data);
...
">
                            ...
                            <div class="single-card-actions-desc form-group">
                                <div class="btn-pair"> 或 <a href="../login">登录企业</a>
                                </div>
                            </div>
                        </form></div></div>
            </div>
