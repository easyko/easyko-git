<?php /* Smarty version Smarty-3.1.12, created on 2019-08-16 16:48:46
         compiled from "F:\www\easyku_src\site\template\login\signup.html" */ ?>
<?php /*%%SmartyHeaderCode:194995d5604dc4b25f0-42171566%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7237193832d747a7b3fcd5e7f7c61578b63ad179' => 
    array (
      0 => 'F:\\www\\easyku_src\\site\\template\\login\\signup.html',
      1 => 1565945325,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '194995d5604dc4b25f0-42171566',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5d5604dc4ea5f9_51565044',
  'variables' => 
  array (
    'title' => 0,
    'formhash' => 0,
...
<?php if ($_valid && !is_callable('content_5d5604dc4ea5f9_51565044')) {function content_5d5604dc4ea5f9_51565044($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        $(function(){
            ...
            $(".getCode").click(function(){
                ...
                $.post('/register/index.php?task=sendsms',{phone: mobile, formhash: formhash},
                    function(data) {
            ...
            $(".next").click(function(){
                ...
                var formhash = $(".formhash").val();
                $.post('/register/index.php?task=register',{phone: mobile, verCode: code, formhash: formhash},
                    function(data) {
                        alert(data);return false;
                        data = JSON.parse(data);
                        if(data.status == 'LOGIN_SUCCESS') {
                            //登陆成功跳转管理内容页面
                            window.location.href = "../main/setup.html";
                        }
                        //ajax返回错误
                        $(".tip").show();
                        $(".tip span.active").html(data.msg);
...
">
                            ...
                            <div class="single-card-actions-desc form-group">
                                <div class="btn-pair"> 或 <a href="signin.html">登录企业</a>
                                </div>
                            </div>
                        </form></div></div>
            </div>
