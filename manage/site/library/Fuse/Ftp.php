...
class Fuse_Ftp
{
	...
	public function __construct($options=array()) {
		...
		if (FTP_NATIVE) {
			include_once(dirname(__FILE__)."/Buffer.php");
		}
	 ...
	 */
	public static function getInstance($host = '', $port = '21', $user = null, $pass = null,$options = null)
	{	
		...
		if (!isset ($instances[$signature]) || !is_object($instances[$signature])) {
			$instances[$signature] = new Fuse_Ftp($options);
		} else {
	...
	public function setRoot($ftp_root){
		$this->_ftp_root = $ftp_root;
	}

	public function getRoot(){
		return $this->_ftp_root;
	}
}
