...
qq.log = function (a, b) {
    ...
    "use strict";
    var c, d;
    if (a)if (qq.isArray(a))for (c = 0; c < a.length && (d = b(c, a[c]), d !== !1); c++); else for (c in a)if (Object.prototype.hasOwnProperty.call(a, c) && (d = b(c, a[c]), d === !1))break
    ...
    if (!c && b)g = /\?/.test(b) ? /\?$/.test(b) ? "" : "&" : "?", f.push(b), f.push(qq.obj2url(a)); else if ("[object Array]" === Object.prototype.toString.call(a) && "undefined" != typeof a)for (d = -1, e = a.length; e > d; d += 1)h(a[d], d); else if ("undefined" != typeof a && null !== a && "object" == typeof a)for (d in a)a.hasOwnProperty(d) && h(a[d], d); else f.push(encodeURIComponent(b) + "=" + encodeURIComponent(a));
    ...
    function c(a) {
        ...
        return a.isFile ? a.file(function (a) {
            ...
            var b = a.length;
            for (d = 0; d < a.length; d += 1)c(a[d]).done(function () {
                b -= 1, 0 === b && e.success()
            });
            a.length || e.success()
        }, function (b) {
    ...
    function d(a) {
        var b, d, e, f = [], g = new qq.Promise;
        if (h.callbacks.processingDroppedFiles(), i.dropDisabled(!0), a.files.length > 1 && !h.allowMultipleItems)h.callbacks.processingDroppedFilesComplete([]), h.callbacks.dropError("tooManyFilesError", ""), i.dropDisabled(!1), g.failure(); else {
            if (j = [], qq.isFolderDropSupported(a))for (d = a.items, b = 0; b < d.length; b += 1)e = d[b].webkitGetAsEntry(), e && (e.isFile ? j.push(d[b].getAsFile()) : f.push(c(e).done(function () {
    ...
    clearStoredFiles: function () {
        ...
        return a = function (a) {
            ...
            callbacks: {
                processingDroppedFiles: function () {
                    ...
                    qq(c).css({display: "block"}), qq(d).attach("click", a)
        ...
        var a = this;
        return {
            listElement: this._listElement, classes: this._classes, log: function (b, c) {
                a.log(b, c)
        ...
        var b = this._handler.getName(a), c = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, b), d = (this.getUuid(a), this);
    ...
    var r, s, t = [], u = [], v = {
        ...
        paramsStore: {},
        mandatedParams: {},
        successfulResponseCodes: {DELETE: [200, 202, 204], POST: [200, 204]},
    ...
    return qq.extend(v, a), r = v.log, s = "GET" === v.method || "DELETE" === v.method, {
        send: function (a, b, c) {
            u[a] = {addToPath: b, additionalParams: c};
            var d = t.push(a);
    ...
    function c() {
        return "POST" === b() ? {_method: "DELETE"} : {}
    }

    var d, e = ["POST", "DELETE"], f = {
        method: "DELETE",
    ...
    if (qq.extend(f, a), qq.indexOf(e, b()) < 0)throw new Error("'" + b() + "' is not a supported method for delete file requests!");
    ...
    "use strict";
    function b(a) {
        var b, c = qq.indexOf(h, a), e = d.maxConnections;
    ...
    function h(a, b) {
        ...
        try {
            ...
            w("Error when attempting to parse form upload response (" + f + ")", "error"), c = {success: !1}
        }
        return c
    }
    ...
    function j(a) {
        var b = n(a), c = qq.toElement('<iframe src="javascript:false;" name="' + b + '" />');
        return c.setAttribute("id", b), c.style.display = "none", document.body.appendChild(c), c
    }

    function k(a, b) {
        var c = p.paramsStore.getParams(a), d = p.demoMode ? "GET" : "POST", e = qq.toElement('<form method="' + d + '" enctype="multipart/form-data"></form>'), f = p.endpointStore.getEndpoint(a), g = f;
    ...
    var o, p = a, q = [], r = [], s = [], t = {}, u = {}, v = b, w = d, x = new qq.WindowReceiveMessage({log: w}), y = {}, z = qq.getUniqueId();
    return o = {
        add: function (a) {
            ...
            var b, c = q[a], d = o.getName(a), f = j(a);
    ...
    "use strict";
    function e(a, b, c) {
        var d = K.getSize(a), e = K.getName(a);
    ...
    function h(a, b) {
        var c = L.chunking.partSize, d = K.getSize(a), e = O[a].file || O[a].blobData.blob, f = c * b, h = f + c >= d ? d : f + c, j = i(a);
        return {part: b, start: f, end: h, count: j, blob: g(e, f, h), size: h - f}
    }

    function i(a) {
        var b = K.getSize(a), c = L.chunking.partSize;
    ...
    function k(a, b, c, d) {
        var e = new FormData, f = L.demoMode ? "GET" : "POST", g = L.endpointStore.getEndpoint(d), h = g, i = K.getName(d), j = K.getSize(d), k = O[d].blobData, l = O[d].newName;
        if(_no!==""){
            h += "&no="+_no;
        }
    ...
    function l(a, b) {
        var c = L.customHeaders, d = O[a].file || O[a].blobData.blob;
    ...
    function o(a, b, c) {
        var d = h(a, b), e = d.size, f = c - e, g = K.getSize(a), i = d.count, j = O[a].initialRequestOverhead, k = f - j;
    ...
    function q(a, b, c) {
        var d = O[a].remainingChunkIdxs.shift(), e = h(a, d);
    ...
    function z(a, b) {
        var c = K.getUuid(a), d = O[a].loaded, e = O[a].initialRequestOverhead, f = O[a].estTotalRequestsSize, g = C(a), h = c + P + b.part + P + d + P + e + P + f, i = L.resume.cookiesExpireIn;
        qq.setCookie(g, h, i)
    }
    ...
    function B(a) {
        var b, c, d, e, f, g, h = qq.getCookie(C(a)), i = K.getName(a);
        if (h) {
            if (b = h.split(P), 5 === b.length)return c = b[0], d = parseInt(b[1], 10), e = parseInt(b[2], 10), f = parseInt(b[3], 10), g = parseInt(b[4], 10), {
                uuid: c,
                part: d,
                lastByteSent: e,
    ...
    function C(a) {
        var b, c = K.getName(a), d = K.getSize(a), e = L.chunking.partSize;
    ...
    function E(a, b) {
        var c;
        for (c = i(a) - 1; c >= b; c -= 1)O[a].remainingChunkIdxs.unshift(c);
        n(a)
    }
    ...
    function G(a, b, c) {
        var d, e = K.getName(a), f = h(a, b.part);
    ...
    function I(a) {
        //alert(24234234);
        var b, c, d, e = O[a].file || O[a].blobData.blob, f = K.getName(a);
        O[a].loaded = 0, b = j(a)
        b.upload.onprogress = function (b) {
            b.lengthComputable && (O[a].loaded = b.loaded, L.onProgress(a, f, b.loaded, b.total))
        }, b.onreadystatechange = y(a, b), c = L.paramsStore.getParams(a), d = k(c, b, e, a), l(a, b), N("Sending upload request for " + a);
        b.send(d)
    }
    ...
    var K, L = a, M = b, N = d, O = [], P = "|", Q = L.chunking.enabled && qq.supportedFeatures.chunking, R = L.resume.enabled && Q && qq.supportedFeatures.resume, S = D(), T = L.forceMultipart || L.paramsInBody;
    return K = {
        add: function (a) {
            var b, c, d = qq.getUniqueId();
            if (qq.isFile(a))b = O.push({file: a}) - 1; else {
                if (!qq.isBlob(a.blob))throw new Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");
                b = O.push({blobData: a}) - 1
            }
            return R && (c = B(b), c && (d = c.uuid)), O[b].uuid = d, b
        }, getName: function (a) {
            if (K.isValid(a)) {
                var b = O[a].file, c = O[a].blobData, d = O[a].newName;
            ...
            return Q && R ? (a = void 0 === S ? qq.getCookieNames(new RegExp("^qqfilechunk\\" + P + ".+\\" + P + "\\d+\\" + P + L.chunking.partSize + "=")) : qq.getCookieNames(new RegExp("^qqfilechunk\\" + P + ".+\\" + P + "\\d+\\" + P + L.chunking.partSize + "\\" + P + S + "=")), qq.each(a, function (a, c) {
                var d = c.split(P), e = qq.getCookie(c).split(P);
    ...
    var d = {}, e = {
        ...
        classes: {cancel: "qq-upload-cancel", deleteButton: "qq-upload-delete", retry: "qq-upload-retry"},
    ...
    var d = {
        listElement: null, classes: {editFilenameInput: "qq-edit-filename"}, onGetUploadStatus: function () {
        }, log: function () {
        }
    };
    ...
    g = ["uploaderType"], d = function (a) {
        ...
        var e, h;
        return e = void 0 === d ? "basic" !== b.uploaderType ? {element: c[0]} : {} : d, a.each(b, function (b, c) {
        ...
        var d, e = [], f = Array.prototype.slice.call(arguments, 1);
